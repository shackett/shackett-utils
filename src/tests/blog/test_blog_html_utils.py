...
class TestExportTabulatorPayload:
    ...
    def test_multiindex_columns(self):
        ...
        col_index = pd.MultiIndex.from_tuples(
            [("Sales", "Q1"), ("Sales", "Q2"), ("Revenue", "Q3"), ("Revenue", "Q4")],
    ...
    def test_both_multiindex(self):
        ...
        row_idx = pd.MultiIndex.from_product(
            [["Group1", "Group2"], ["ItemA", "ItemB"]], names=["Group", "Item"]
        )
        col_idx = pd.MultiIndex.from_product(
            [["Metric1", "Metric2"], ["Val1", "Val2"]], names=["Metric", "Value"]
        )
        ...
        )  # index + two parent columns (Metric1, Metric2)
    ...
    def test_empty_dataframe(self):
        ...
        assert (
            result["columns"] == []
        )  # Empty DataFrame with include_columns=True returns empty list
    ...
    def test_empty_dataframe_no_columns(self):
        ...
        )  # When include_columns=False, columns should be None
    ...
    def test_multiindex_with_nan_values(self):
        ...
        data = {"Q1": [100, 150, 120, 180], "Q2": [110, 160, 130, 190]}
        ...
        assert result["table"][0]["index"] == "North / ProductA"
        assert (
            "nan" in result["table"][1]["index"]
        )  # NaN becomes 'nan' in string conversion
